...
var FormLabel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(label_1.Label, __assign({ ref: ref, className: cn(error && "text-destructive", className), htmlFor: formItemId }, props)));
});
...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formDescriptionId, className: cn("text-[0.8rem] text-muted-foreground", className) }, props)));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formMessageId, className: cn("text-[0.8rem] font-medium text-destructive", className) }, props), body));
});
